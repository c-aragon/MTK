...
<html>
	...
	<body>
		<div id="edit-collaborator" class="container" role="main">

			<div class="page-header"> 
				<h2> <i class="fa fa-credit-card-alt"></i> <g:message code="default.edit.collaborator.label"/> </h2> 
			</div>
					...
					<g:form url="[resource:collaboratorInstance, action:'update']" method="PUT" >
						...
						<div class="form-group"> 
							<div class="col-lg-offset-3 col-xs-2"> 
								<g:submitButton name="create" class="btn btn-primary" value="${message(code: 'default.button.update.label')}" />
							</div>
						</div>
					</g:form>
				</div>
